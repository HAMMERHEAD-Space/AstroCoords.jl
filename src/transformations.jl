...
function (t::CartesianToEDromoTransform)(x::Cartesian, μ::Number; kwargs...)
    ...
    return EDromo{eltype(edromo_vec)}(edromo_vec[1], edromo_vec[2], edromo_vec[3], edromo_vec[4], edromo_vec[5], edromo_vec[6], edromo_vec[7], edromo_vec[8])
end
...
function (t::EDromoToCartesianTransform)(x::EDromo, μ::Number; kwargs...)
    ...
    return Cartesian{eltype(cart_vec)}(cart_vec[1], cart_vec[2], cart_vec[3], cart_vec[4], cart_vec[5], cart_vec[6])
end
...
function (t::CartesianToKustaanheimoStiefelTransform)(x::Cartesian, μ::Number; kwargs...)
    ...
    return KustaanheimoStiefel{eltype(ks_vec)}(ks_vec[1], ks_vec[2], ks_vec[3], ks_vec[4], ks_vec[5], ks_vec[6], ks_vec[7], ks_vec[8], ks_vec[9], ks_vec[10])
end
...
function (t::CartesianToStiefelScheifeleTransform)(x::Cartesian, μ::Number; kwargs...)
    ...
    return StiefelScheifele{eltype(ss_vec)}(ss_vec[1], ss_vec[2], ss_vec[3], ss_vec[4], ss_vec[5], ss_vec[6], ss_vec[7], ss_vec[8], ss_vec[9], ss_vec[10])
end
