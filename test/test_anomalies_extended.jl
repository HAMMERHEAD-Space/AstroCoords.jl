...
@testset "Anomaly Conversions Extended" begin
    @testset "KeplerSolver for elliptic orbits (e<1)" begin
        ...
        test_cases = [
            ...
            (M=π, e=0.1, desc="Low eccentricity at apoapsis"),
        ...
        for tc in test_cases
            ...
            @test M_recovered ≈ tc.M atol=1e-10
        end
    end
    ...
    @testset "KeplerSolver for hyperbolic orbits (e>1)" begin
        ...
        test_cases = [
            ...
            (M=-0.5, e=1.5, desc="Negative mean anomaly"),
        ]
    ...
    @testset "Near-parabolic cases (e≈0.999, e≈1.001)" begin
    ...
    @testset "Eccentric→true anomaly conversions" begin
        ...
        for tc in test_cases
            ...
            @test E_recovered ≈ tc.E atol=1e-10
        end
    ...
    @testset "True→eccentric→mean round-trips" begin
        ...
        for tc in test_cases
            ...
            @test f_recovered ≈ tc.f atol=1e-10
        end
    end
    ...
    @testset "Edge cases and special values" begin
        ...
        M = π/4
        f = KeplerSolver(M, e)
        @test f ≈ M atol=1e-10  # For circular orbit, f = M = E
    end
end
