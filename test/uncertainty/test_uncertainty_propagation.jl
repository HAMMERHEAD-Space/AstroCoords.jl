...
@testset "Uncertainty Propagation Methods" begin
    ...
    @testset "Unscented Transform - sigma point generation" begin
        ...
        mean_recon, cov_recon = reconstruct_statistics(sigma_points, weights_mean, weights_cov)
    ...
    @testset "Edge case - zero uncertainty" begin
        ...
        @test_throws Union{LinearAlgebra.PosDefException, ErrorException} propagate_unscented(unc_kep, transform, μ)
    end
