...
@testset "Transformation Infrastructure" begin
    ...
    @testset "@define_transformation_pair Macro Expansion" begin
        # Verify that the macro-generated types exist
        @test isdefined(AstroCoords, :CartesianToKeplerianTransform)
        @test isdefined(AstroCoords, :KeplerianToCartesianTransform)
        @test isdefined(AstroCoords, :CartesianToModEqTransform)
        @test isdefined(AstroCoords, :ModEqToCartesianTransform)
        
        # Verify transformation constants are defined
    ...
    @testset "Transformation Type Hierarchy" begin
        ...
        @test AstroCoords.CartesianToKeplerianTransform <: AstroCoords.AstroCoordTransformation
        @test AstroCoords.AstroCoordTransformation <: AstroCoords.AstrodynamicsTransformation
    ...
    @testset "ComposedTransformation - Cartesian→Keplerian→ModEq" begin
        ...
        composed = cart_to_kep ∘ kep_to_modeq
    ...
    @testset "Transformation Type Promotion (Float32/Float64)" begin
        ...
        cart = Cartesian(Float32(7000.0), Float32(0.0), Float32(0.0), 
                        Float32(0.0), Float32(7.5), Float32(0.0))
